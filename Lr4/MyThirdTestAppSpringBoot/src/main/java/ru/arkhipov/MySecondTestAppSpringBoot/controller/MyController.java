...
public class MyController {
    ...
    public MyController(ValidationService validationService,
                        ...
                        ModifyRequestService modifySystemTimeRequestService){
    ...
    public ResponseEntity<Response> feedback(@Valid @RequestBody Request request,
        ...
        String service1RequestTime = request.getSystemTime();
        ...
        log.info("Time difference: {} milliseconds", DateTimeUtil.calculateTimeDifference(service1RequestTime, request.getSystemTime()));
